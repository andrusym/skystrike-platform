...
async def build_order(ticker: str, contracts: int, dte: int, mode: str) -> Dict[str, Any]:
    """
    Construct a directional or balanced unbalanced iron fly for theta farming.
    """
    ...
    logger.info(f"[GAMMAFLY] {ticker} spread {short_strike}/{long_strike} exp {expiration} x{contracts}")
