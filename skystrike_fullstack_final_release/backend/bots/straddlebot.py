...
async def build_order(ticker: str, contracts: int, dte: int, mode: str) -> Dict[str, Any]:
    """
    Buy an ATM straddle for volatility breakout or event-driven moves.
    """
    ...
    logger.info(f"[STRADDLEBOT] {ticker} spread {short_strike}/{long_strike} exp {expiration} x{contracts}")
