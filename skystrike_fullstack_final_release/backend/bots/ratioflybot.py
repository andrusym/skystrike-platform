...
async def build_order(ticker: str, contracts: int, dte: int, mode: str) -> Dict[str, Any]:
    """
    Enter a 1-2-1 or 1-3-2 butterfly with defined risk and directional lean.
    """
    ...
    logger.info(f"[RATIOFLYBOT] {ticker} spread {short_strike}/{long_strike} exp {expiration} x{contracts}")
